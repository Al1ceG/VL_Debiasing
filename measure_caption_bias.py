...
def main():
    ...
    parser.add_argument(
        '--results_filename',
        default="VL_Debiasing/results/clipcap_debiased_sfid_debiased.csv",
        type=str,
    ...
    prefix_length = 10
    model_path = 'C:\\Users\\patta\\Desktop\\VL_Debiasing\\clip_debiasing\\models\\clipcap\\clip_cap_coco_weight.pt'
