...
for clip_model in model_list:
    ...
    train_save_path = f'unified_debiasing/embedding/{prefix}_facet_train_data_dict.pt'
    val_save_path = f'unified_debiasing/embedding/{prefix}_facet_val_data_dict.pt'
